...
public class Node {
    ...
    public Node(int peerID, String peerType, String peerIP, List<Integer> neighborPeerIDs, Map<Integer,String> peerIPMap, String item) {
        this.peerID = peerID;
        this.peerIP = peerIP;
    ...
    private void generatePeer(int peerID, String peerType, String peerIP, List<Integer> neighborPeerIDs, Map<Integer, String> peerIPMap, String item) {
        switch (peerType) {
            case BUYER:
